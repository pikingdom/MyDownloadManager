...
/**
 * 插件开发TabActivity时,需要继承此类
 * 
 * @ClassName: PluginTabActivity
...
public class PluginTabActivity extends TabActivity implements IActivityGroupPlugin {
	...
	public TabHost getTabHost() {
		if (mPluginMode) {
			TabHost tabHost = ((TabActivity) mPluginLoaderActivity).getTabHost();
	...
	public TabWidget getTabWidget() {
		if (mPluginMode) {
			return ((TabActivity) mPluginLoaderActivity).getTabWidget();
		} else {
