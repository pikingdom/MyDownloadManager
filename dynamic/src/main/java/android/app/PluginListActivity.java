...
import com.android.dynamic.plugin.IActivityPlugin;
import com.android.dynamic.plugin.PluginActivity;
import com.android.dynamic.plugin.PluginUtil;

/**
 * 插件开发ListActivity时,需要继承此类
 * 
 * @ClassName: PluginListActivity
 * @author lytjackson@gmail.com
 * @date 2014-2-27
 * 
 */
public class PluginListActivity extends ListActivity implements IActivityPlugin {
	...
	public void setListAdapter(ListAdapter adapter) {
		if (mPluginMode) {
			((ListActivity) mPluginLoaderActivity).setListAdapter(adapter);
		} else {
	...
	public ListView getListView() {
		if (mPluginMode) {
			return ((ListActivity) mPluginLoaderActivity).getListView();
		} else {
